...
const expenses = [
  { id: "1", userId: "u1", amount: 2000, category: "Food" as const, description: "Dinner", date: "2026-06-01" },
  { id: "2", userId: "u1", amount: 5000, category: "Travel" as const, description: "Cab", date: "2026-06-02" }
];
