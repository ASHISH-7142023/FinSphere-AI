export function calculateBudgetUsage(expenses, budgets) {
...
export function getOverspendingAlerts(expenses, budgets) {
    return budgets
        .map((budget) => {
...
export function simulateCreditScore(profile) {
...
export function gradeFinancialHealth(score) {
    if (score <= 40)
        return "Poor";
    if (score <= 60)
        return "Average";
