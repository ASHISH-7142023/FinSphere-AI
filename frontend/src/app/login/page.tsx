            ...
            <>
              {isCustomGoogle ? (
                <div>
                  ...
                  <h3 className="text-xl font-normal text-center text-[#e8eaed]">Sign in with Google</h3>
                  ...
                  <div className="mt-8 space-y-4">
                    <div className="space-y-1">
                      <label className="text-[10px] uppercase font-bold text-[#9aa0a6] tracking-wider">Full Name</label>
                      <input
                        type="text"
                        className="w-full bg-[#2a2b30] border border-[#3c4043] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-[#1a73e8]"
                        placeholder="Alex Sterling"
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] uppercase font-bold text-[#9aa0a6] tracking-wider">Email Address</label>
                      <input
                        type="email"
                        className="w-full bg-[#2a2b30] border border-[#3c4043] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-[#1a73e8]"
                ...
                {isCustomGoogle ? (
                  <>
                    <button
                      ...
                      onClick={() => handleOAuthComplete("google", customGoogleName, customGoogleEmail)}
                      className="w-full py-2.5 rounded-xl bg-[#1a73e8] hover:bg-[#1557b0] transition-colors text-xs font-bold text-white flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      <span>Sign In</span>
                    ...
                    <button
                      ...
                      className="w-full py-2.5 rounded-xl border border-[#3c4043] hover:bg-white/5 transition-colors text-xs font-semibold text-[#9aa0a6]"
                    >
                      Back
                    </button>
                  </>
            ...
            <>
              <div>
                ...
                <div className="mt-8 space-y-3">
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase font-bold text-[#86868b] tracking-wider">Full Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase font-bold text-[#86868b] tracking-wider">Apple ID (Email)</label>
                    <input
                      type="email"
                      className="w-full bg-[#1c1c1e] border border-[#3a3a3c] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-[#0a84ff]"
                      value={appleEmail}
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      type="password"
                      className="w-full bg-[#1c1c1e] border border-[#3a3a3c] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-[#0a84ff] opacity-60"
                      defaultValue="••••••••••••"
                      readOnly
                    />
                  </div>
              ...
              <div className="space-y-3">
                <button
                  type="button"
                  disabled={!appleName || !appleEmail}
                  onClick={() => handleOAuthComplete("apple", appleName, appleEmail)}
                  className="w-full py-3 rounded-xl bg-white text-black font-bold text-xs hover:bg-neutral-200 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  <span>Continue</span>
