...
import PersonalExpenseLedger from "./PersonalExpenseLedger";
...
export default function ExpensesView({
  ...
  // Sum expenses per category for the Analysis dashboard
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sub Tab Switcher at the very top */}
      <div className="flex border-b border-white/5 pb-2 justify-between items-center flex-wrap gap-4">
        <div className="flex gap-1 bg-surface-container/50 p-1 rounded-xl border border-white/5">
          <button
      ...
      {activeSubTab === "ledger" ? (
        ...
        <div className="space-y-6">
              ...
              <div className="bg-surface-container p-1 rounded-xl flex items-center border border-white/5">
                <button
                  ...
                  className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${
                    cycleTab === "month" ? "bg-primary text-background shadow-md" : "text-on-surface-variant hover:text-on-surface"
                  }`}
                >
                  Month
                </button>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${
                    cycleTab === "quarter" ? "bg-primary text-background shadow-md" : "text-on-surface-variant hover:text-on-surface"
                  }`}
                >
                  Quarter
                </button>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${
                    cycleTab === "year" ? "bg-primary text-background shadow-md" : "text-on-surface-variant hover:text-on-surface"
                  }`}
                >
                  Year
                </button>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            {/* Transactions Ledger (Original static list view) */}
